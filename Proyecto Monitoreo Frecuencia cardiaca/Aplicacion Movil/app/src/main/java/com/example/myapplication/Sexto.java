...
public class Sexto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void run() {
                while (b == true) {
                    try {
                        ...
                        if (lol > 86 || lol < 70) {
                            new Sexto.CargarDatos().execute("http://" + IP + "/" + sitio + "/" + "insertar_datos.php?cidM="+d4+"&cidU="+d3+"&cfre="+t1.getText().toString());
        ...
        logo.start();
        if (ActivityCompat.checkSelfPermission(Sexto.this, Manifest.permission.SEND_SMS)
                != PackageManager.PERMISSION_GRANTED
                && ActivityCompat.checkSelfPermission(Sexto.this, Manifest.permission.SEND_SMS)
                != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(Sexto.this, new String[]
        ...
        salir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Sexto.this, Login.class);
                startActivity(i);
