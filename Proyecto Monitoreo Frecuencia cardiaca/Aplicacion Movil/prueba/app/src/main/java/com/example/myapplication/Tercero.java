...
public class Tercero extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void run() {
                while (b == true) {
                    try {
                        ...
                        if (lol > 86 || lol < 70) {
                            new Tercero.CargarDatos().execute("http://" + IP + "/" + sitio + "/" + "insertar_datos.php?cidM="+d4+"&cidU="+d3+"&cfre="+t1.getText().toString());
        ...
        logo.start();
        if (ActivityCompat.checkSelfPermission(Tercero.this, Manifest.permission.SEND_SMS)
                != PackageManager.PERMISSION_GRANTED
                && ActivityCompat.checkSelfPermission(Tercero.this, Manifest.permission.SEND_SMS)
                != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(Tercero.this, new String[]
        ...
        salir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Tercero.this, Login.class);
                startActivity(i);
